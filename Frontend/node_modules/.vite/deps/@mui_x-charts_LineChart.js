import {
  useThemeProps
} from "./chunk-4B7VE6WY.js";
import {
  internal_createExtendSxProp,
  memoTheme_default
} from "./chunk-KQEYWAG7.js";
import {
  HTMLElementType,
  _extends,
  capitalize,
...
var Typography = React67.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(TypographyRoot, {
    as: Component,
    ref,
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React74.useMemo(
  ...
  const padding = React74.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React74.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React74.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React74.useMemo(() => {
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React77.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime41.jsxs)(React78.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime43.jsxs)(React80.Fragment, {
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(React85.Fragment, {
    children: yTicks.map(({
      value,
      offset: offset2
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(React87.Fragment, {});
}
...
var LineChart = React91.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
